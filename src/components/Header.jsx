      ...
      <div className="max-w-[1400px] mx-auto px-5 py-2 sm:flex  justify-between  items-center">
        <Link to={"/"}>
          <div className="flex items-center justify-center">
            ...
            <span className="mx-3 text-lg font-ds font-extrabold tracking-widest text-black">
              SUNRISE
            </span>
          </div>
        </Link>
        <div className="relative p-2 flex gap-4 justify-center items-center ">
          <form className="flex " onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              className="bg-[#000] text-white ml-2 p-2 px-2 rounded-md shadow-md"
            >
              <svg
                className="w-5 h-5"
                // fill="black"
          ...
          <div className="absolute top-14 bg-slate-300 w-[95%] rounded-lg">
